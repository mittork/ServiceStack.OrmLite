...
using ServiceStack.OrmLite.MySqlConnector.DataAnnotations;
using ServiceStack.Text;

namespace ServiceStack.OrmLite.MySqlConnector
{
    public class MySqlConnectorDialectProvider : OrmLiteDialectProviderBase<MySqlConnectorDialectProvider>
    {
        ...
        private const string MediumTextColumnDefinition = "MEDIUMTEXT";
        private const string LongTextColumnDefinition = "LONGTEXT";
        ...
        public override string GetColumnDefinition(FieldDefinition fieldDef)
        {
            ...
            {
                return GetTextColumnDefinition(fieldDef, TextColumnDefinition);
            }
            if (fieldDef.PropertyInfo.FirstAttribute<MediumTextAttribute>() != null)
            {
                return GetTextColumnDefinition(fieldDef, MediumTextColumnDefinition);
            }
            if (fieldDef.PropertyInfo.FirstAttribute<LongTextAttribute>() != null)
            {
                return GetTextColumnDefinition(fieldDef, LongTextColumnDefinition);
            }
        ...
        private string GetTextColumnDefinition(FieldDefinition fieldDef, string columnDefinition)
        {
            var sql = StringBuilderCache.Allocate();
            sql.AppendFormat("{0} {1}", GetQuotedColumnName(fieldDef.FieldName), columnDefinition);
